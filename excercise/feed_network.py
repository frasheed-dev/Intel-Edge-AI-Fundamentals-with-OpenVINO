...
def load_to_IE(model_xml, cpu_ext):
    ...
    model_bin = os.path.splitext(model_xml)[0] + ".bin" #remove model file extension and add ".bin" at the end of model_xml file name
    net = IENetwork(model=model_xml, weights=model_bin) #loading model
